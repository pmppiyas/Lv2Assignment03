...
bookSchema.static("borrowBook", function (_a) {
    return __awaiter(this, arguments, void 0, function* ({ book, quantity, dueDate }) {
        const Book = mongoose_1.default.model("Book");
        const BorrowModel = mongoose_1.default.model("Borrow");
        const foundBook = yield Book.findById(book);
        if (!foundBook) {
        ...
        const borrowRecord = yield BorrowModel.create({
            book,
            quantity,
            dueDate,
        });
